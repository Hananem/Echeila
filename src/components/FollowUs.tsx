...
<motion.div
  ...
  initial="hidden"
  animate={controls}
  className="relative w-[70%] pb-20 mt-40 mx-auto rounded-2xl p-6 flex flex-col items-center gap-4 shadow-md overflow-visible"
>
  {/* Backgrounds */}
  ...
  <motion.img
    ...
    src="/Logo2.png"
    alt="Logo"
    className="w-24 h-24 z-10 absolute -top-12"
  />
  ...
  <div className="pt-12"></div>
      ...
      <motion.h2
        variants={childVariants}
        className="bg-clip-text text-transparent bg-gradient-to-b from-gray-800 to-gray-600 text-center z-10 text-[28px]"
        style={{ fontFamily: "Pacifico, cursive" }}
      >
        تابع حساباتنا على وسائل التواصل الاجتماعي
      </motion.h2>

      {/* Social Icons */}
      <motion.div
        variants={childVariants}
        className="flex gap-6 z-10 mt-5"
      >
        {/* Facebook */}
        <a
          href="https://www.facebook.com/profile.php?id=61580453194431&rdid=P5C9MXD4pbvlV7Ly&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1AmXu4EPAn%2F"
          target="_blank"
          rel="noopener noreferrer"
          className="p-3 rounded-full shadow-md bg-white cursor-pointer hover:scale-110 transition-transform"
        >
          <svg
            width="25px"
            height="25px"
  ...
  <motion.div
    ...
    className="flex flex-col items-center gap-3 mt-8 z-10 text-center"
  >
    <h3  className="bg-clip-text text-transparent bg-gradient-to-b from-gray-800 to-gray-600 text-center z-10 text-[28px]"
        style={{ fontFamily: "Pacifico, cursive" }}>تواصل معنا</h3>
    ...
    <div className="flex items-center gap-2 text-gray-700">
      ...
      <span>echeilaecheila@gmail.com</span>
    </div>
  </motion.div>
    </motion.div>
  );
